...
const AppointmentScreen = () => {
  ...
  return (
      <View className="flex-1 bg-sky-50 mb-24">
        {/* Gradient Background */}
        <LinearGradient
            colors={['#E0F7FA', '#05525b']}
        ...
        >
          ...
          <View className="flex-row items-center mb-4">
            <TouchableOpacity onPress={() => router.back()} className="p-2">
              <Icon name="arrow-back-outline" size={24} color="#3B82F6"/>
            </TouchableOpacity>
            <Text className="text-2xl font-psemibold text-gray-800 ml-4">Đặt Lịch Hẹn</Text>
          </View>
